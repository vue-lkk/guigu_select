<template>
  <div>
    ...
    <el-card style="margin-top: 10px">
      <!-- 0:默认渲染 -->
      <div v-show="scene == 0">
        <el-button type="primary" icon="Plus" :disabled="categoryStore.c3_ID ? false : true" @click="addSpu">添加SPU</el-button>
        <!-- 表格 -->
        <el-table border style="width: 100%;margin-top:10px" :data="spuList" stripe>
          ...
          <el-table-column label="操作">
            <template #="{ row, column, $index }">
              ...
              <el-button size="small" type="success" icon="View" title="查看SKU列表"></el-button>
...
const getSpuList = async () => {
  ...
  let result: supDate = await reqSpuList(currentPage.value, pageSize.value, c3_ID)
  console.log(result)
  if (result.code == 200) {
