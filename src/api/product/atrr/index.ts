...
// 获取属性
export const reqAttrInfoList = (c1_ID: number | string,c2_ID: number | string,c3_ID: number | string) => 
  request.get<any,attrResponseData>(api.C123_url + `${c1_ID}/${c2_ID}/${c3_ID}`)
